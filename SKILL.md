...
social-promo-asset-rollout-checker の作業手順です。
...
- asset は `dist/social-promo-asset-rollout-checker-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md`。
